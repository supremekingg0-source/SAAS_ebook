...
const generateOutline = async (req, res) => {
    try {
        ...
        2. Each chapter title should be clear, engaging, and follow a loical progression
        ...
        [
            ...
            },
            {
                ...
                "description": "Explores the fundamental principles and theories. Provides detailed examples and real-world application."
            }
        ]
        
        Genearte the outline now:`;
...
const generateChapterContent = async (req, res) => {
    try {
        ...
        const promt = `You are an expert writer specilizing in ${style} content. Write a complete chapter for a book with the following specifications:
